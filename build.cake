...
Task("__Pack")
    .Does(() => {
        ...
        CopyFileToDirectory(solutionDir + "Server" + bin452 + "Octopus.Server.Extensibility.Authentication.Guest.dll", odNugetPackDir);
    ...
    .Does(() =>
{
    ...
    CopyFileToDirectory(Path.Combine(artifactsDir, $"Octopus.Client.Extensibility.Authentication.Guest.{nugetVersion}.nupkg"), localPackagesDir);
});
